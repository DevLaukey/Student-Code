...
// Updated updatePipeline function
// Updated updatePipeline function
// Updated updatePipeline function
void Cpu::updatePipeline()
{
    ...
    regIDEX_EXside.registerNum = (regIFID_IDside.regDst) ? regIFID_IDside.rd : regIFID_IDside.rt;
    regIDEX_EXside.aluResult = regIFID_IDside.immed_se;
    ...
    regIFID_IDside.rd = 1;       // Set to 1 for simplicity, update according to your needs
    regIFID_IDside.rt = 2;       // Set to 2 for simplicity, update according to your needs
    regIFID_IDside.immed_se = imem.value(regIFID_IFside.next_pc);
    regIFID_IDside.instruction = regIFID_IFside.instruction;
...
// Updated isProgramComplete function
